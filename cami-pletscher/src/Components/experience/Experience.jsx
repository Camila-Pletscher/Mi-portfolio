      ...
      <div className={styles.cont_info_exp}>
        <div data-aos="zoom-in" className={styles.cont_each_exp}>
          <div className={styles.pad_txt}>
            ...
            <p className={styles.three}>
              ...
              de sitios con JavaScript. Desarrollo de aplicación Open Peds
              “Learn Peritoneal Dialysis” con ReactJs.
            </p>
          </div>
        ...
        <div data-aos="zoom-in" className={styles.cont_each_exp}>
          <div className={styles.pad_txt}>
            ...
            <p className={styles.three}>
              Diseño de piezas gráficas y desarrollo de email marketing para
              empresas como Boehringer Ingelheim, Teva, Astrazenca, Vifor, entre
              otros.
            </p>
          </div>
